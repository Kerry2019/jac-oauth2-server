...
import com.definesys.portal.oauth.jacoauth2server.handler.LogoutHandlerImpl;
...
public class CustomWebSecurityConfigurerAdapter extends WebSecurityConfigurerAdapter {
    private final AuthenticationFailureHandler appLoginFailureHandler;
    private final LdapSecurityProperty ldapSecurityProperty;

    public CustomWebSecurityConfigurerAdapter(AuthenticationFailureHandler appLoginFailureHandler, LdapSecurityProperty ldapSecurityProperty) {
        this.appLoginFailureHandler = appLoginFailureHandler;
        this.ldapSecurityProperty = ldapSecurityProperty;
    }
    ...
    public void configure(WebSecurity web) throws Exception {
        web.ignoring().antMatchers("/oauth/logout", "/paas/**", "/uaa/open/**");
    }
